...
Classic SPITFIRE-Inspired 1.5.0 is an independently authored presentation
...
Version 1.5.0 is installed by current post-0.1.0 source. The latest downloadable
...
```text
Active: classic-spitfire 1.5.0
Base: modern-ng 1.4.0
...
Version 1.5.0 retains the caller Main, Sysop Main, Messages, Files, and Sysop
visual treatments introduced by earlier releases, the project-authored
LOCKOUT/SUBWARN/SFSUBCHG caller-access boundaries, and adds the Tranche 5
R/V safe-inspection mappings. Those resources
