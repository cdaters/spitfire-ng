...
sfconfig-help-callers = Caller limits are minutes/calls. Profile collection accepts disabled, optional, or required. Journey accepts none or stock. Subscription enabled accepts true/false. Existing sessions keep their policy; subsequent sessions use saved values.
...
sfconfig-help-security = Security levels are 0..9999. Password minimum/maximum and login attempts use shared validation. Security edits require Change sensitive configuration in addition to Change configuration. No caller passwords are read here.
